...
const MOCK_STRUCTURES: AnatomicalStructure[] = [
  // Head
  { id: 'brain', structure_code: 'BRAIN', structure_name: 'Cerveau', structure_category: 'nervous', body_zone: 'head', laterality: 'bilateral', volume_ml: 1400, default_color: '#F472B6', opacity: 0.8 },
  { id: 'skull', structure_code: 'SKULL', structure_name: 'Crâne', structure_category: 'skeletal', body_zone: 'head', laterality: 'bilateral', default_color: '#E5E7EB', opacity: 0.3 },
  
  // Thorax
  { id: 'heart', structure_code: 'HEART', structure_name: 'Cœur', structure_category: 'cardio', body_zone: 'thorax', laterality: 'center', volume_ml: 320, default_color: '#EF4444', opacity: 0.9 },
  { id: 'lung_left', structure_code: 'LUNG_L', structure_name: 'Poumon Gauche', structure_category: 'pulmo', body_zone: 'thorax', laterality: 'left', volume_ml: 2500, default_color: '#FDA4AF', opacity: 0.7 },
  { id: 'lung_right', structure_code: 'LUNG_R', structure_name: 'Poumon Droit', structure_category: 'pulmo', body_zone: 'thorax', laterality: 'right', volume_ml: 2800, default_color: '#FDA4AF', opacity: 0.7 },
  { id: 'aorta', structure_code: 'AORTA', structure_name: 'Aorte', structure_category: 'cardio', body_zone: 'thorax', laterality: 'center', default_color: '#DC2626', opacity: 0.9 },
  { id: 'ribs', structure_code: 'RIBS', structure_name: 'Côtes', structure_category: 'skeletal', body_zone: 'thorax', laterality: 'bilateral', default_color: '#E5E7EB', opacity: 0.3 },
  
  // Abdomen
  { id: 'liver', structure_code: 'LIVER', structure_name: 'Foie', structure_category: 'digestive', body_zone: 'abdomen', laterality: 'right', volume_ml: 1500, default_color: '#92400E', opacity: 0.85 },
  { id: 'spleen', structure_code: 'SPLEEN', structure_name: 'Rate', structure_category: 'digestive', body_zone: 'abdomen', laterality: 'left', volume_ml: 150, default_color: '#7C3AED', opacity: 0.85 },
  { id: 'stomach', structure_code: 'STOMACH', structure_name: 'Estomac', structure_category: 'digestive', body_zone: 'abdomen', laterality: 'center', volume_ml: 1000, default_color: '#F59E0B', opacity: 0.8 },
  { id: 'kidney_left', structure_code: 'KIDNEY_L', structure_name: 'Rein Gauche', structure_category: 'digestive', body_zone: 'abdomen', laterality: 'left', volume_ml: 150, default_color: '#B91C1C', opacity: 0.85 },
  { id: 'kidney_right', structure_code: 'KIDNEY_R', structure_name: 'Rein Droit', structure_category: 'digestive', body_zone: 'abdomen', laterality: 'right', volume_ml: 150, default_color: '#B91C1C', opacity: 0.85 },
  
  // Pelvis
  { id: 'bladder', structure_code: 'BLADDER', structure_name: 'Vessie', structure_category: 'digestive', body_zone: 'pelvis', laterality: 'center', volume_ml: 400, default_color: '#FBBF24', opacity: 0.75 },
  { id: 'pelvis_bone', structure_code: 'PELVIS', structure_name: 'Bassin', structure_category: 'skeletal', body_zone: 'pelvis', laterality: 'bilateral', default_color: '#E5E7EB', opacity: 0.3 },
];
